    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file$3, 58, 4, 1963);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(58:3) {#each period as period}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$3, 47, 2, 1462);
    			attr_dev(input0, "class", "form-input svelte-3aywy4");
    			attr_dev(input0, "name", "username");
    			attr_dev(input0, "type", "text");
    			add_location(input0, file$3, 48, 2, 1531);
    			add_location(br0, file$3, 48, 76, 1605);
    			add_location(div0, file$3, 46, 1, 1453);
    			attr_dev(label1, "class", "form-label svelte-3aywy4");
    			attr_dev(label1, "for", "limit");
    			add_location(label1, file$3, 51, 2, 1630);
    			attr_dev(input1, "class", "form-input svelte-3aywy4");
    			attr_dev(input1, "name", "limit");
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "min", "1");
    			attr_dev(input1, "max", "100");
    			add_location(input1, file$3, 52, 2, 1691);
    			add_location(br1, file$3, 52, 86, 1775);
    			add_location(div1, file$3, 50, 1, 1621);
    			attr_dev(label2, "class", "form-label svelte-3aywy4");
    			attr_dev(label2, "for", "period");
    			add_location(label2, file$3, 55, 1, 1799);
    			...
    			add_location(select, file$3, 56, 2, 1861);
    			add_location(br2, file$3, 60, 11, 2013);
    			add_location(div2, file$3, 54, 1, 1791);
    			attr_dev(form, "class", "item-form");
    			add_location(form, file$3, 45, 1, 1390);
    			...
    			add_location(button0, file$3, 63, 1, 2039);
    			attr_dev(label3, "for", "output");
    			attr_dev(label3, "class", "form-label svelte-3aywy4");
    			add_location(label3, file$3, 66, 2, 2191);
    			...
    			add_location(textarea, file$3, 67, 2, 2268);
    			attr_dev(div3, "class", "item-output");
    			add_location(div3, file$3, 65, 1, 2162);
    			...
    			add_location(button1, file$3, 69, 1, 2385);
    			attr_dev(div4, "class", "container svelte-3aywy4");
    			add_location(div4, file$3, 44, 0, 1364);
    		},
