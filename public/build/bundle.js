...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file$3, 78, 4, 2323);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$3, 67, 2, 1833);
    			attr_dev(input0, "class", "form-input svelte-3aywy4");
    			attr_dev(input0, "name", "username");
    			attr_dev(input0, "type", "text");
    			add_location(input0, file$3, 68, 2, 1901);
    			add_location(br0, file$3, 68, 76, 1975);
    			add_location(div0, file$3, 66, 1, 1825);
    			attr_dev(label1, "class", "form-label svelte-3aywy4");
    			attr_dev(label1, "for", "limit");
    			add_location(label1, file$3, 71, 2, 1997);
    			attr_dev(input1, "class", "form-input svelte-3aywy4");
    			attr_dev(input1, "name", "limit");
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "min", "1");
    			attr_dev(input1, "max", "100");
    			add_location(input1, file$3, 72, 2, 2057);
    			add_location(br1, file$3, 72, 86, 2141);
    			add_location(div1, file$3, 70, 1, 1989);
    			attr_dev(label2, "class", "form-label svelte-3aywy4");
    			attr_dev(label2, "for", "period");
    			add_location(label2, file$3, 75, 1, 2162);
    			...
    			add_location(select, file$3, 76, 2, 2223);
    			add_location(br2, file$3, 80, 11, 2371);
    			add_location(div2, file$3, 74, 1, 2155);
    			attr_dev(form, "class", "item-form");
    			add_location(form, file$3, 65, 1, 1763);
    			attr_dev(i, "class", "fa-brands fa-lastfm");
    			add_location(i, file$3, 83, 110, 2503);
    			...
    			add_location(button0, file$3, 83, 1, 2394);
    			attr_dev(label3, "for", "output");
    			attr_dev(label3, "class", "form-label svelte-3aywy4");
    			add_location(label3, file$3, 86, 2, 2579);
    			...
    			add_location(textarea, file$3, 87, 2, 2655);
    			attr_dev(div3, "class", "item-output");
    			add_location(div3, file$3, 85, 1, 2551);
    			...
    			add_location(button1, file$3, 89, 1, 2770);
    			attr_dev(div4, "class", "container svelte-3aywy4");
    			add_location(div4, file$3, 64, 0, 1738);
    		},
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 51, 4, 1463);
    			add_location(button, file$2, 53, 6, 1552);
    			attr_dev(a, "href", /*$appUrl*/ ctx[1]);
    			add_location(a, file$2, 52, 4, 1527);
    			attr_dev(section, "class", "expired-token");
    			add_location(section, file$2, 50, 2, 1427);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(15:2) {#if !$token || $tokenExpired}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-1mze3wx");
    			add_location(h2, file, 10, 2, 308);
    			attr_dev(div0, "id", "head");
    			add_location(div0, file, 9, 1, 290);
    			attr_dev(main, "id", "main");
    			attr_dev(main, "class", "svelte-1mze3wx");
    			add_location(main, file, 13, 1, 382);
    			attr_dev(i, "class", "fa-brands fa-github");
    			add_location(i, file, 26, 3, 700);
    			attr_dev(a, "href", "https://github.com/leorehm/lastfm-spotify");
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "class", "svelte-1mze3wx");
    			add_location(a, file, 25, 2, 628);
    			attr_dev(footer, "id", "footer");
    			attr_dev(footer, "class", "svelte-1mze3wx");
    			add_location(footer, file, 24, 1, 605);
    			attr_dev(div1, "id", "app");
    			attr_dev(div1, "class", "svelte-1mze3wx");
    			add_location(div1, file, 8, 0, 274);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
