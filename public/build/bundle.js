    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file$3, 53, 4, 1774);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$3, 42, 2, 1273);
    			attr_dev(input0, "class", "form-input svelte-et0bzl");
    			attr_dev(input0, "name", "username");
    			attr_dev(input0, "type", "text");
    			add_location(input0, file$3, 43, 2, 1342);
    			add_location(br0, file$3, 43, 76, 1416);
    			add_location(div0, file$3, 41, 1, 1264);
    			attr_dev(label1, "class", "form-label svelte-et0bzl");
    			attr_dev(label1, "for", "limit");
    			add_location(label1, file$3, 46, 2, 1441);
    			attr_dev(input1, "class", "form-input svelte-et0bzl");
    			attr_dev(input1, "name", "limit");
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "min", "1");
    			attr_dev(input1, "max", "100");
    			add_location(input1, file$3, 47, 2, 1502);
    			add_location(br1, file$3, 47, 86, 1586);
    			add_location(div1, file$3, 45, 1, 1432);
    			attr_dev(label2, "class", "form-label svelte-et0bzl");
    			attr_dev(label2, "for", "period");
    			add_location(label2, file$3, 50, 1, 1610);
    			...
    			add_location(select, file$3, 51, 2, 1672);
    			add_location(br2, file$3, 55, 11, 1824);
    			add_location(div2, file$3, 49, 1, 1602);
    			...
    			add_location(button0, file$3, 57, 2, 1841);
    			attr_dev(form, "class", "item-form svelte-et0bzl");
    			add_location(form, file$3, 40, 1, 1201);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 34, 6, 1100);
    			attr_dev(a, "href", /*loginLink*/ ctx[2]);
    			add_location(a, file$2, 33, 4, 1072);
    			add_location(br, file$2, 36, 4, 1169);
    			attr_dev(label, "id", "checkbox-text");
    			attr_dev(label, "for", "remember-me");
    			attr_dev(label, "class", "svelte-181gumj");
    			add_location(label, file$2, 38, 6, 1218);
    			...
    			add_location(div0, file$2, 37, 4, 1181);
    			attr_dev(div1, "id", "login");
    			attr_dev(div1, "class", "svelte-181gumj");
    			add_location(div1, file$2, 32, 2, 1050);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$1, 129, 0, 4110);
    			attr_dev(input0, "class", "input");
    			attr_dev(input0, "name", "playlist-name");
    			attr_dev(input0, "type", "text");
    			add_location(input0, file$1, 130, 0, 4174);
    			add_location(br0, file$1, 130, 78, 4252);
    			attr_dev(label1, "class", "label");
    			attr_dev(label1, "for", "playlist-desc");
    			add_location(label1, file$1, 132, 0, 4260);
    			attr_dev(input1, "class", "input");
    			attr_dev(input1, "name", "playlist-desc");
    			attr_dev(input1, "type", "text");
    			add_location(input1, file$1, 133, 0, 4322);
    			add_location(br1, file$1, 133, 78, 4400);
    			add_location(button, file$1, 135, 0, 4408);
    			add_location(p, file$1, 137, 0, 4476);
    		},
    		l: function claim(nodes) {
