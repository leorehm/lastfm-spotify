    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$1, 129, 0, 4130);
    			attr_dev(input0, "class", "input");
    			attr_dev(input0, "name", "playlist-name");
    			attr_dev(input0, "type", "text");
    			add_location(input0, file$1, 130, 0, 4194);
    			add_location(br0, file$1, 130, 78, 4272);
    			attr_dev(label1, "class", "label");
    			attr_dev(label1, "for", "playlist-desc");
    			add_location(label1, file$1, 132, 0, 4280);
    			attr_dev(input1, "class", "input");
    			attr_dev(input1, "name", "playlist-desc");
    			attr_dev(input1, "type", "text");
    			add_location(input1, file$1, 133, 0, 4342);
    			add_location(br1, file$1, 133, 78, 4420);
    			add_location(button, file$1, 135, 0, 4428);
    			add_location(p, file$1, 137, 0, 4496);
    		},
    		l: function claim(nodes) {
