...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$1, 136, 0, 4298);
    			attr_dev(input0, "class", "input");
    			attr_dev(input0, "name", "playlist-name");
    			attr_dev(input0, "type", "text");
    			add_location(input0, file$1, 137, 0, 4362);
    			add_location(br0, file$1, 137, 78, 4440);
    			attr_dev(label1, "class", "label");
    			attr_dev(label1, "for", "playlist-desc");
    			add_location(label1, file$1, 139, 0, 4448);
    			attr_dev(input1, "class", "input");
    			attr_dev(input1, "name", "playlist-desc");
    			attr_dev(input1, "type", "text");
    			add_location(input1, file$1, 140, 0, 4510);
    			add_location(br1, file$1, 140, 78, 4588);
    			add_location(button, file$1, 142, 0, 4596);
    			add_location(p, file$1, 144, 0, 4664);
    		},
    		l: function claim(nodes) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	validate_store(tokenExpired, 'tokenExpired');
    	component_subscribe($$self, tokenExpired, $$value => $$invalidate(10, $tokenExpired = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
