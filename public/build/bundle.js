    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 51, 4, 1530);
    			add_location(button, file$2, 53, 6, 1621);
    			attr_dev(a, "href", /*$appUrl*/ ctx[1]);
    			add_location(a, file$2, 52, 4, 1595);
    			attr_dev(section, "class", "expired-token");
    			add_location(section, file$2, 50, 2, 1493);
    		},
    		m: function mount(target, anchor) {
