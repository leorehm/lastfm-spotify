...
var app = (function () {
    ...
    const file$2 = "src\\components\\LfmForm.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file$2, 51, 4, 1748);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(51:3) {#each period as period}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t12 = text("Next");
    			attr_dev(label0, "class", "form-label svelte-16mug8m");
    			attr_dev(label0, "for", "username");
    			add_location(label0, file$2, 42, 2, 1274);
    			attr_dev(input0, "class", "form-input svelte-16mug8m");
    			attr_dev(input0, "name", "username");
    			attr_dev(input0, "type", "text");
    			add_location(input0, file$2, 43, 2, 1343);
    			add_location(br0, file$2, 43, 76, 1417);
    			attr_dev(label1, "class", "form-label svelte-16mug8m");
    			attr_dev(label1, "for", "limit");
    			add_location(label1, file$2, 45, 2, 1427);
    			attr_dev(input1, "class", "form-input svelte-16mug8m");
    			attr_dev(input1, "name", "limit");
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "min", "1");
    			attr_dev(input1, "max", "100");
    			add_location(input1, file$2, 46, 2, 1488);
    			add_location(br1, file$2, 46, 86, 1572);
    			attr_dev(label2, "class", "form-label svelte-16mug8m");
    			attr_dev(label2, "for", "period");
    			add_location(label2, file$2, 48, 2, 1584);
    			attr_dev(select, "class", "form-input svelte-16mug8m");
    			attr_dev(select, "name", "period");
    			if (/*chosenPeriod*/ ctx[1] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[9].call(select));
    			add_location(select, file$2, 49, 2, 1646);
    			add_location(br2, file$2, 53, 11, 1798);
    			attr_dev(button0, "id", "submit-button");
    			attr_dev(button0, "class", "svelte-16mug8m");
    			add_location(button0, file$2, 55, 2, 1808);
    			attr_dev(form, "class", "item-form svelte-16mug8m");
    			add_location(form, file$2, 40, 1, 1208);
    			textarea.readOnly = true;
    			attr_dev(textarea, "id", "song-output");
    			attr_dev(textarea, "rows", "limit");
    			attr_dev(textarea, "cols", "50");
    			attr_dev(textarea, "class", "svelte-16mug8m");
    			add_location(textarea, file$2, 59, 2, 1922);
    			attr_dev(div0, "class", "item-output svelte-16mug8m");
    			add_location(div0, file$2, 58, 1, 1893);
    			attr_dev(div1, "class", "container svelte-16mug8m");
    			add_location(div1, file$2, 39, 0, 1182);
    			attr_dev(button1, "id", "next-button");
    			button1.disabled = button1_disabled_value = /*output*/ ctx[3] == "";
    			attr_dev(button1, "class", "svelte-16mug8m");
    			add_location(button1, file$2, 62, 0, 2027);
    		},
    ...
    const file$1 = "src\\components\\SpotifyLogin.svelte";
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			input = element("input");
    			attr_dev(button, "class", "login-btn");
    			add_location(button, file$1, 34, 6, 1100);
    			attr_dev(a, "href", /*loginLink*/ ctx[2]);
    			add_location(a, file$1, 33, 4, 1072);
    			add_location(br, file$1, 36, 4, 1169);
    			attr_dev(label, "id", "checkbox-text");
    			attr_dev(label, "for", "remember-me");
    			add_location(label, file$1, 38, 6, 1218);
    			attr_dev(input, "id", "checkbox-box");
    			attr_dev(input, "name", "remember-me");
    			attr_dev(input, "type", "checkbox");
    			add_location(input, file$1, 39, 6, 1290);
    			attr_dev(div0, "id", "checkbox-container");
    			add_location(div0, file$1, 37, 4, 1181);
    			attr_dev(div1, "id", "login");
    			add_location(div1, file$1, 32, 2, 1050);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, a);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 51, 4, 1514);
    			add_location(button, file$1, 53, 6, 1605);
    			attr_dev(a, "href", /*$appUrl*/ ctx[1]);
    			add_location(a, file$1, 52, 4, 1579);
    			attr_dev(section, "class", "expired-token");
    			add_location(section, file$1, 50, 2, 1477);
    		},
    		m: function mount(target, anchor) {
    ...
    const file = "src\\components\\CreatePlaylist.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			label = element("label");
    			label.textContent = "Name der Playlist";
    			t1 = space();
    			input = element("input");
    			br = element("br");
    			t2 = space();
    			button = element("button");
    			button.textContent = "Playlist erstellen";
    			attr_dev(label, "class", "label");
    			attr_dev(label, "for", "playlist-name");
    			add_location(label, file, 128, 0, 4056);
    			attr_dev(input, "class", "input");
    			attr_dev(input, "name", "playlist-name");
    			attr_dev(input, "type", "text");
    			add_location(input, file, 129, 0, 4124);
    			add_location(br, file, 129, 78, 4202);
    			add_location(button, file, 131, 0, 4210);
    		},
    		l: function claim(nodes) {
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*playlistName*/ ctx[0]);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*createPlaylist*/ ctx[1], { once: true }, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*playlistName*/ 1 && input.value !== /*playlistName*/ ctx[0]) {
    				set_input_value(input, /*playlistName*/ ctx[0]);
    			}
    		},
    		i: noop,
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	validate_store(trackdata, 'trackdata');
    	component_subscribe($$self, trackdata, $$value => $$invalidate(6, $trackdata = $$value));
    	validate_store(tokenExpired, 'tokenExpired');
    	component_subscribe($$self, tokenExpired, $$value => $$invalidate(7, $tokenExpired = $$value));
    	validate_store(timeRange, 'timeRange');
    	component_subscribe($$self, timeRange, $$value => $$invalidate(8, $timeRange = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('playlistDesc' in $$props) playlistDesc = $$props.playlistDesc;
    	...
    	return [playlistName, createPlaylist, input_input_handler];
    }
